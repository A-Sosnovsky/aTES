...
builder.Services.AddDbContext<ApplicationDbContext>(opt =>
    opt.UseNpgsql(builder.Configuration.GetConnectionString("auth")));

// Register our TokenService dependency
builder.Services.AddScoped<TokenService, TokenService>()
    .AddScoped<IEventsService, EventsService>();

AddKafka(builder.Services);
...
void AddKafka(IServiceCollection services)
{
    const string serviceName = "auth-service";
    var brokenAddress = new[] { "localhost:9092" };
